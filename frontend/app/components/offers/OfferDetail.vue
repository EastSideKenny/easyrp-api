    ...
    <div v-if="offer" class="space-y-6">
        ...
        >
            <table class="w-full text-sm">
                ...
                <tbody>
                    <tr
                        v-for="response in offer.responses"
                        :key="response.id"
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td
                            class="px-6 py-3 text-right tabular-nums text-text-muted"
                        >
                            {{ item.tax_rate }}%
                        </td>
                        <td
                ...
                <tfoot>
                    <tr class="border-t border-border">
                        <td
                            colspan="4"
                            class="px-6 py-3 text-right text-text-muted"
                        >
                            Subtotal
                        </td>
                        <td
                    ...
                    <tr>
                        <td
                            colspan="4"
                            class="px-6 py-1 text-right text-text-muted"
                        >
                            Tax
                        </td>
